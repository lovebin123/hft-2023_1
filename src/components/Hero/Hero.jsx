      ...
      <div className="hero__txt">
        ...
        <div className="hero__rem_time" data-aos="flip-down" >
          <div className="hero__time" >
            <div className="time_item hero__days"><h3>98</h3><p>Days</p></div>
            <div className="time_item hero__hours"><h3>21</h3><p>Hours</p></div>
            <div className="time_item hero__mins"><h3>16</h3><p>Mins</p></div>
            <div className="time_item hero__secs"><h3>26</h3><p>Secs</p></div>
